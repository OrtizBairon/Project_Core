...
{
    public partial class Project_CoreContext : DbContext
    {
        public Project_CoreContext()
        {
        }

        public Project_CoreContext(DbContextOptions<Project_CoreContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-089IVD0\\SQLEXPRESS;Database=Project_Core;User ID=adminbd;Password=admin");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspNetUsers>(entity =>
            {
                ...
                entity.HasOne(d => d.Tenant)
                    ...
                    .HasConstraintName("FK__AspNetUse__Tenan__0C85DE4D");
            });
            ...
            modelBuilder.Entity<Members>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Members__UserId__0B91BA14");
            });
            ...
            modelBuilder.Entity<UserProjects>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserProjects)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__UserProje__UserI__0A9D95DB");
            });
